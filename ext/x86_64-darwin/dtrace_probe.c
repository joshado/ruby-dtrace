...
VALUE dtraceprobe_init(VALUE self, VALUE rargc)
{
  ...
  case 0:
	...
	0x00, 0xc9, 0xc3, 0x00
      ...
      install_insns(probe_insns, &insns[IS_ENABLED_FUNC_LEN], 3);
    }
    break;
  ...
  case 6:
	...
	0x00, 0xc9, 0xc3, 0x00
      ...
      install_insns(probe_insns, &insns[IS_ENABLED_FUNC_LEN], 17);
    }
    break;
  ...
  case 8:
	...
	0x40, 0x00, 0xc9, 0xc3
      ...
      install_insns(probe_insns, &insns[IS_ENABLED_FUNC_LEN], 21);
    }
    break;
...
VALUE dtraceprobe_probe_offset(VALUE self, VALUE file_addr, VALUE argc)
{
  void *probe_addr;
  int offset;
  int offsets[9] = { 6, 16, 21, 27, 33, 43, 61, 71, 78 };

  probe_addr = (void *)NUM2LL(rb_funcall(self, rb_intern("addr"), 0));

  offset = offsets[FIX2INT(argc)];
  offset += IS_ENABLED_FUNC_LEN;

  fprintf(stderr, "argc: %d, offset: %d\n", FIX2INT(argc), offset);
